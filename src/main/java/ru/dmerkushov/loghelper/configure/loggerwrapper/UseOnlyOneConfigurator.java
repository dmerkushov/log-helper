 ...
 */
public class UseOnlyOneConfigurator extends WrappingConfigurator {

	public UseOnlyOneConfigurator (LoggerWrapper loggerWrapper, Node configuration) {
	...
	public boolean configure () {
		...
		boolean success = getWrappedConfigurator ().configure ();
		return success;
	}
